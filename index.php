    ...
    <div class="content">
        ...
        <div class="section group">
            ...
            <div class="box">
                ...
                <?php
                        $productbl = $product->sumbl($result_new['productId']);
                        $id = 0;
                        if ($productbl) {
                            while ($result = $productbl->fetch_assoc()) {
                                $id++;
                            }
                        } ?>
                <span class="start-result-count" style="float: right; margin-right: 5px;">
        ...
        <div class="section group">
            <?php
            $product_new = $product->getAll_Iphone_bn();
            if ($product_new) {
                while ($result_new = $product_new->fetch_assoc()) { ?>
            <div class="box">
                <div class="product-top">
        ...
        <div class="content_bottom">
            ...
            <div class="All" style="float: right;">
                <?php $product_all = $product->getAll_Iphone();
        ...
        <div class="section group">
            <?php
        $product_new = $product->getproduct_Iphone();
        if ($product_new) {
            while ($result_new = $product_new->fetch_assoc()) { ?>
            <div class="box">
                <div class="product-top">
