    ...
    <div class="content">
                ...
                <div class="check_gia">
                    <div class="options">
                        <label class="container-checkbox">
                            <a rel="nofollow" href="">Dưới 5 triệu <input type="checkbox"><span
                                    class="checkmark"></span></a></label>
                        <label class="container-checkbox">
                            <a rel="nofollow" href="">Từ 5 đến 10 triệu <input type="checkbox"> <span
                                    class="checkmark"></span></a>
                        </label>
                        <label class="container-checkbox">
                            <a rel="nofollow" href="">Từ 10 đến 20 triệu <input type="checkbox" checked=""><span
                                    class="checkmark"></span></a>
                        </label>
                        <label class="container-checkbox">
                            <a rel="nofollow" href="">Trên 20 triệu <input type="checkbox"><span
                                    class="checkmark"></span></a>
                        </label>
                    </div>
                </div>
                <div class="link_boloc">
                    ...
                    <div class="a_boloc">
                        ...
                        <div id="sort-dropdown" class="dropdown-content">
                            <a rel="nofollow" href="?catid=<?php echo $result_name['catId'] ?>&&actionid=hmv">Hàng mới
                                về</a>
                            <a rel="nofollow" href="?catid=<?php echo $result_name['catId'] ?>&&actionid=AZ">A =&gt;
                                Z</a>
                            <a rel="nofollow" href="?catid=<?php echo $result_name['catId'] ?>&&actionid=ZA">Z =&gt;
                                A</a>
                            <a rel="nofollow" href="?catid=<?php echo $result_name['catId'] ?>&&actionid=tang">Giá tăng
                                dần</a>
                            <a rel="nofollow" href="?catid=<?php echo $result_name['catId'] ?>&&actionid=giam">Giá giảm
                                dần</a>
                        </div>
                        <?php
                    }
        ...
        <div class="section group">
            ...
            <div class="box">
                ...
                <a href="details.php?proid=<?php echo $result['productId'] ?>"><img class="image"
                ...
                <div class="product-price vat">
                    <span>
                        <del
                            style="margin-left: 20px;"><?php echo $fm->format_currency($result['price_promotion']) . " " . "VNĐ" ?></del>
                        <?php echo $fm->format_currency($result['price']) . " " . "VNĐ" ?>
                    </span>
                </div>
                <?php
                                $productbl = $product->sumbl($result['productId']);
                                $id = 0;
                                if ($productbl) {
                                    while ($result1 = $productbl->fetch_assoc()) {
                                        $id++;
                                    }
                                } ?>
                <span class="start-result-count" style="float: right; margin-right: 5px;">
                    <?php echo $id ?> bình luận</span>
                <div class="text_none">
                    <div class="sort">
        ...
        <div class="btn12">
            ...
            <a class="phantrang" <?php if ($i == $trang) {
                ...
                href="index.php?trang=<?php echo $i ?>"><span><?php echo $i ?></span></a>
            <?php
                    }
                    ?>
        </div>
