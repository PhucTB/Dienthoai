...
class product
{
	...
	public function insert_product($data, $files)
	{
		...
		$price1 = mysqli_real_escape_string($this->db->link, $data['price_promotion']);
		...
		if ($productName == "" || $brand == "" || $category == "" || $product_desc == "" || $price == "" || $type == "" || $file_name == "") {
			...
			$query = "INSERT INTO tbl_product(productName,brandId,catId,product_desc,price,price_promotion,type,image) VALUES('$productName','$brand','$category','$product_desc','$price','$price1','$type','$unique_image')";
